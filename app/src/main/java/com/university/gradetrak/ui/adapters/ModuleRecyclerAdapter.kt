...
class ModuleRecyclerAdapter (private val dataSet : List<Module>) : RecyclerView.Adapter<ModuleRecyclerAdapter.ViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(R.layout.home_page_recycler_view, parent, false)
